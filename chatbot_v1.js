...
function report_issue(agent)
{
  ...
  var issue_vals={1:"MRI Scan",2:"CT Scan",3:"X-RAY",4:"ULTRASOUND"};
 ...
 agent.add("The Scan requested is: "+ val +"\nThe ticket number is: "+trouble_ticket+" please be seated in room 101 we will call you");
}
    ...
    [
      {
        "type": "list",
        "title": "MRI Scan",
        "subtitle": "Press '1' for MRI scanning",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
      ...
      },
      {
        "type": "list",
        "title": "ULTRASOUND",
        "subtitle": "Press '4' Ultrasound Scan",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
